...
export function AgenciesUI({ initialAgencies }: AgenciesUIProps) {
      ...
      {showAddForm && (
        <div style={{ background: 'var(--card-bg)', padding: '2rem', borderRadius: '24px', border: '1px solid var(--glass-border)', marginBottom: '2rem' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', marginTop: '1.5rem' }}>
            <button onClick={handleAddAgency} disabled={loading} style={{ background: 'var(--accent-primary)', color: 'white', border: 'none', padding: '0.6rem 2rem', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold' }}>حفظ</button>
